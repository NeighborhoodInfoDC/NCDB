...
data Ncdb.Ncdb_2010_md;

  set Census.Census_pl_2010_md;
  where sumlev = "140";
  
  ** Geography **;
  
  length UCOUNTY $ 5 GEO2010 $ 11;
  ...
  ** Housing **;
  ...
  drop 
    ...
    COUSUBSC PLACE PLACECC PLACESC BLKGRP BLOCK IUC CONCIT CONCITCC CONCITSC AIANHH AIANHHFP AIANHHCC 
...
%File_info( data=Ncdb.Ncdb_2010_md )
