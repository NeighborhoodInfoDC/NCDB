...
proc summary data=Ncdb_2010_was03_blk nway;
  class geo2010;
  id metro03 ucounty state;
  var adult: child: max: min: mr: non: occ: shr: tot: trct: vac:;
  output sum=
    out=Ncdb.Ncdb_2010_was03 
          (label='NCDB, 2010, Washington region (2003)' sortedby=geo2010 drop=_freq_ _type_);
run;

%File_info( data=Ncdb.Ncdb_2010_was03, freqvars=state ucounty metro03 )
