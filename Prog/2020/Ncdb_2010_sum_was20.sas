/**************************************************************************
 Program:  Ncdb_2010_sum_was20.sas
 Library:  NCDB
...
for Washington metro area (2020).
...
data Ncdb_sum_&year._was20_tr10;

  set Ncdb.Ncdb_2010_was20;
...
proc datasets library=Work memtype=(data);
  modify Ncdb_sum_&year._was20_tr10;
  label
...
%Finalize_data_set( 
  ...
  data=Ncdb_sum_&year._was20_tr10,
  out=Ncdb_sum_&year._was20_tr10,
  outlib=NCDB,
  label="NCDB summary, 2010, Washington region (2020), Census tract (2010)",
  sortby=Geo2010,
  /** Metadata parameters **/
  restrictions=None,
...
proc summary data=Ncdb_sum_&year._was20_tr10;
...
%Finalize_data_set( 
  /** Finalize data set parameters **/
  data=Ncdb_sum_&year._was20_regcnt,
  out=Ncdb_sum_&year._was20_regcnt,
  outlib=NCDB,
  label="NCDB summary, 2010, Washington region (2020), County",
  sortby=county,
  /** Metadata parameters **/
  restrictions=None,
  revisions=%str(New file.),
