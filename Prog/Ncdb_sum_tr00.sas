/**************************************************************************
 ...
 Description:  Create tract-level summary file from NCDB 1970-2000
 data.

 Modifications:
  07/22/12 PAT Filled in missing variable labels. 
               Renamed NumHsgUnitsBlt: variables (NumHsgUnitsBuilt:).
**************************************************************************/
...
%macro Summary( year );
  ...
  %if &year = 1970 %then %do;
    %let y = 7;
    %let data = Ncdb_1970_2000_dc;
    %let geo = geo2000;
  %end;
  %else %if &year = 1980 %then %do;
    %let y = 8;
    %let data = Ncdb_1980_2000_dc;
    %let geo = geo2000;
  %end;
  %else %if &year = 1990 %then %do;
    %let y = 9;
    %let data = Ncdb_1990_2000_dc;
    %let geo = geo2000;
  %end;
  %else %if &year = 2000 %then %do;
    %let y = 0;
    %let data = Ncdb_lf_2000_dc;
    %let geo = _char_;
  %end;
  %else %do;
    %err_mput( macro=Summary, msg=Invalid value for YEAR=&year. )
    %goto exit;
  %end;

data Ncdb_sum_tr00_&year (compress=no);
...
proc datasets library=work memtype=(data) nolist;
  modify Ncdb_sum_tr00_&year;
  label %include "[dcdata.ncdb.prog]Sum_var_labels.inc"; ;
quit;
...
data Ncdb.Ncdb_sum_tr00 (label="NCDB summary" sortedby=geo2000);
  ...
  */
  ...
  drop 
    NumHHMovedIn20YearsOrMore_1970 NumHHMovedInLast5Years_1970
    NumHsgUnitsBlt31to40YrsAgo_1970 NumHsgUnitsBlt41to50YrsAgo_1970
    NumHsgUnitsBuilt95toMar00_1970 NumHsgUnitsBuiltBef70_1970
    NumHsgUnitsBuiltBef50_1970 NumHsgUnitsOthStrExcMobile_1970
    NumHshldsforPctInc_1970 NumHshldsOver30PctInc_1970 NumHshldsOver50PctInc_1970
    NumHshldsOvercrowded_1970 NumHshldsSevOvercrowded_1970
    NumHshldsWInc100000plus_1970 NumHshldsWInc15000to34999_1970
    NumHshldsWInc35000to49999_1970 NumHshldsWInc50000to74999_1970
    NumHshldsWIncUnder15000_1970 NumOccupiedHsgUnitsNHWhite_1970
    NumOwnerHshldsforPctInc_1970 NumOwnerHshldsOver30PctInc_1970
    NumOwnerHshldsOver50PctInc_1970 NumOwnerOccHsgUnitsNHWhite_1970
    NumRenterHshldsforPctInc_1970 NumRenterHshldsOver30PctInc_1970
    NumRenterHshldsOver50PctInc_1970 NumRenterHshldsRent1000plus_1970
    NumRenterHshldsRent300to399_1970 NumRenterHshldsRent400to499_1970
    NumRenterHshldsRent500to599_1970 NumRenterHshldsRent600to699_1970
    NumRenterHshldsRent700to799_1970 NumRenterHshldsRent800to999_1970
    NumRenterHshldsRentUnder300_1970 NumRenterOccHsgUnitsNHWhite_1970
    Pop16to19UnemplOutOfSchool_1970 Pop18to64PoorEnglishLang_1970
    Pop5to17PoorEnglishLang_1970 Pop65andOverPoorEnglishLang_1970
    PopAsianPILangAtHome_1970 PopAsianPINonHispBridge_1970
    PopBlackNonHispBridge_1970 PopEmployedIndAgricMining_1970
    PopEmployedIndArts_1970 PopEmployedIndEducational_1970 PopEmployedIndFIRE_1970
    PopEmployedIndProfessional_1970 PopEmployedIndTransport_1970
    PopEmployedOccConstruction_1970 PopEmployedOccManagement_1970
    PopEmployedOccProduction_1970 PopEmployedOccSales_1970
    PopEmployedOccService_1970 PopEnglishLangAtHome_1970 PopOtherLangAtHome_1970
    PopSpanishLangAtHome_1970 PopWhiteNonHispAlone_1970 PopWhiteNonHispBridge_1970
    NumSpecOwnerOccHsgUnits_1970 NumSpecRenterOccHsgUnits_1970
    NumHHMovedIn20YearsOrMore_1980 NumHHMovedIn20YearsOrMore_1990
    NumHHMovedInLast5Years_1980 NumHHMovedInLast5Years_1990
    NumHsgUnitsBuilt95toMar00_1980 NumHsgUnitsBuilt95toMar00_1990
    NumHsgUnitsOthStrExcMobile_1980 NumHshldsforPctInc_1980 NumHshldsforPctInc_1990
    NumHshldsOver30PctInc_1980 NumHshldsOver30PctInc_1990 NumHshldsOver50PctInc_1980
    NumHshldsOver50PctInc_1990 NumHshldsOvercrowded_1980 NumHshldsOvercrowded_1990
    NumHshldsSevOvercrowded_1980 NumHshldsSevOvercrowded_1990
    NumHshldsWInc100000plus_1980 NumHshldsWInc100000plus_1990
    NumHshldsWInc15000to34999_1980 NumHshldsWInc15000to34999_1990
    NumHshldsWInc35000to49999_1980 NumHshldsWInc35000to49999_1990
    NumHshldsWInc50000to74999_1980 NumHshldsWInc50000to74999_1990
    NumHshldsWIncUnder15000_1980 NumHshldsWIncUnder15000_1990
    NumOccupiedHsgUnitsNHWhite_1980 NumOwnerHshldsforPctInc_1980
    NumOwnerHshldsforPctInc_1990 NumOwnerHshldsOver30PctInc_1980
    NumOwnerHshldsOver30PctInc_1990 NumOwnerHshldsOver50PctInc_1980
    NumOwnerHshldsOver50PctInc_1990 NumOwnerOccHsgUnitsNHWhite_1980
    NumRenterHshldsforPctInc_1980 NumRenterHshldsforPctInc_1990
    NumRenterHshldsOver30PctInc_1980 NumRenterHshldsOver30PctInc_1990
    NumRenterHshldsOver50PctInc_1980 NumRenterHshldsOver50PctInc_1990
    NumRenterHshldsRent1000plus_1980 NumRenterHshldsRent1000plus_1990
    NumRenterHshldsRent300to399_1980 NumRenterHshldsRent300to399_1990
    NumRenterHshldsRent400to499_1980 NumRenterHshldsRent400to499_1990
    NumRenterHshldsRent500to599_1980 NumRenterHshldsRent500to599_1990
    NumRenterHshldsRent600to699_1980 NumRenterHshldsRent600to699_1990
    NumRenterHshldsRent700to799_1980 NumRenterHshldsRent700to799_1990
    NumRenterHshldsRent800to999_1980 NumRenterHshldsRent800to999_1990
    NumRenterHshldsRentUnder300_1980 NumRenterHshldsRentUnder300_1990
    NumRenterOccHsgUnitsNHWhite_1980 Pop16to19UnemplOutOfSchool_1980
    Pop18to64PoorEnglishLang_1980 Pop65andOverPoorEnglishLang_1980
    PopAsianPILangAtHome_1980 PopAsianPINonHispBridge_1980
    PopEmployedIndAgricMining_1980 PopEmployedIndAgricMining_1990
    PopEmployedIndArts_1980 PopEmployedIndArts_1990 PopEmployedIndEducational_1980
    PopEmployedIndEducational_1990 PopEmployedIndFIRE_1980 PopEmployedIndFIRE_1990
    PopEmployedIndProfessional_1980 PopEmployedIndProfessional_1990
    PopEmployedIndTransport_1980 PopEmployedIndTransport_1990
    PopEmployedOccConstruction_1980 PopEmployedOccConstruction_1990
    PopEmployedOccManagement_1980 PopEmployedOccManagement_1990
    PopEmployedOccProduction_1980 PopEmployedOccProduction_1990
    PopEmployedOccSales_1980 PopEmployedOccSales_1990 PopEmployedOccService_1980
    PopEmployedOccService_1990 PopOtherLangAtHome_1980 PopWhiteNonHispAlone_1980
    PopWhiteNonHispAlone_1990;

run;


%File_info( Data=Ncdb.Ncdb_sum_tr00, printobs=0 )
